...
to the [latest release](https://marketplace.upbound.io/providers/chicoribas/provider-github):
```
up ctp provider install chicoribas/provider-github:v0.1.0
```
...
spec:
  package: chicoribas/provider-github:v0.1.0
EOF
```
